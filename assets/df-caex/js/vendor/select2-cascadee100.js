        ...
        parent.select2().on("change", function (e) {
            ...
            wp_jsonp("wp_jsonp", method, 'GET', parameters, function(items){
                ...
                if(items.Estado){
                    ...
                    //var sessionData = JSON.parse(sessionStorage.getItem('cotizar'));
                    //if(sessionData){
                        //if(parentId == sessionData[parentObj.data('storage-property')]){
                            loadStep('cotizar', child.selector, child.data('storage-property'));
                        //}
                    //}
