	...
	<div class="container">
		...
		<div class="div container-fluid">
			<div class="row">
				...
				<?php echo form_open("user/resetpassword",
...
<!-- 				<div class="form-group">
					<div class="pnLabelContainer">
						<label for="" class="">Ingrese los Caracteres de la Imagen</label>
					</div>
					<div class="pnInputContainer">
						<input type="text" name="captcha" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" required />
					</div>
				</div> -->
					<div class="form-group">
						<br />
